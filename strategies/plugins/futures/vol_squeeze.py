...
class VolSqueeze(StrategyBase):
    ...
    def init(self, context: StrategyContext) -> None:
        ...
        self.logger.info(f"VolSqueeze initialized with entry_score={self.entry_score}")
    ...
    def on_exit(self, context: StrategyContext) -> None:
        """策略退出時的清理工作。"""
        self.logger.info("VolSqueeze shutting down...")
