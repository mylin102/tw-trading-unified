...
async def ls(path: str, client: modal.client._Client, task_id: str) -> list[str]:
    """List the contents of the provided directory."""
    ...

async def mkdir(path: str, client: modal.client._Client, task_id: str, parents: bool = False) -> None:
    """Create a new directory."""
    ...

async def rm(path: str, client: modal.client._Client, task_id: str, recursive: bool = False) -> None:
    """Remove a file or directory in the Sandbox."""
    ...

def _end_of_watch_event(item: bytes, buffer: _io.BytesIO, boundary_token: bytes) -> bool: ...
def watch(
    path: str,
    client: modal.client._Client,
    task_id: str,
