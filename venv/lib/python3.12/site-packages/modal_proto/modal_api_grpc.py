...
class ModalClientModal:
    ...
    def __init__(self, grpclib_stub: modal_proto.api_grpc.ModalClientStub, client: "modal.client._Client", server_url: str) -> None:
        ...
        self.ContainerServerLifecycleReady = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.ContainerServerLifecycleReady, client, server_url)
        self.ContainerStop = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.ContainerStop, client, server_url)
        self.CurlGetAuthToken = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.CurlGetAuthToken, client, server_url)
        ...
        self.EndpointGetByName = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.EndpointGetByName, client, server_url)
        self.EndpointGetLifecycle = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.EndpointGetLifecycle, client, server_url)
        self.EndpointList = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.EndpointList, client, server_url)
        self.EndpointStop = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.EndpointStop, client, server_url)
        self.EnvironmentBillingSummary = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.EnvironmentBillingSummary, client, server_url)
        ...
        self.EnvironmentGetBudget = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.EnvironmentGetBudget, client, server_url)
        ...
        self.EnvironmentSetBudget = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.EnvironmentSetBudget, client, server_url)
        ...
        self.ImageGetByTag = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.ImageGetByTag, client, server_url)
        ...
        self.ImageListTags = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.ImageListTags, client, server_url)
        self.ImagePublish = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.ImagePublish, client, server_url)
        self.ImageTagRevisions = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.ImageTagRevisions, client, server_url)
        ...
        self.MountBatchedCheckExistence = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.MountBatchedCheckExistence, client, server_url)
        ...
        self.SandboxGetFromNameV2 = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.SandboxGetFromNameV2, client, server_url)
        ...
        self.SandboxListV2 = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.SandboxListV2, client, server_url)
        ...
        self.SandboxTagsGetV2 = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.SandboxTagsGetV2, client, server_url)
        self.SandboxTagsSet = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.SandboxTagsSet, client, server_url)
        self.SandboxTagsSetV2 = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.SandboxTagsSetV2, client, server_url)
        ...
        self.WebhookTokenCreate = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.WebhookTokenCreate, client, server_url)
        self.WebhookTokenDelete = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.WebhookTokenDelete, client, server_url)
        self.WebhookTokenEnvironmentAdd = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.WebhookTokenEnvironmentAdd, client, server_url)
        self.WebhookTokenEnvironmentList = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.WebhookTokenEnvironmentList, client, server_url)
        self.WebhookTokenEnvironmentRemove = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.WebhookTokenEnvironmentRemove, client, server_url)
        self.WebhookTokenList = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.WebhookTokenList, client, server_url)
        self.WebhookTokenListForEnvironment = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.WebhookTokenListForEnvironment, client, server_url)
        self.WorkspaceBillingReport = modal._grpc_client.UnaryStreamWrapper(grpclib_stub.WorkspaceBillingReport, client, server_url)
        self.WorkspaceBillingSummary = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.WorkspaceBillingSummary, client, server_url)
        ...
        self.WorkspaceSetDefaultEnvironment = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.WorkspaceSetDefaultEnvironment, client, server_url)
        self.WorkspaceSetImageBuilderVersion = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.WorkspaceSetImageBuilderVersion, client, server_url)
        self.WorkspaceSettings = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.WorkspaceSettings, client, server_url)
