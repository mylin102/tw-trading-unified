...
PV = 50; DELTA = 0.5; ENTRY_P = 100; THETA = 0.3
ENTRY_SCORE = 60; SL_PCT = 0.20; TP_PCT = 0.8; COOLDOWN = 3; TRAIL = 0.15
...
def run(label, iv_max, iv_spike_entry):
    ...
    if blocked_iv: print(f"  IV 擋掉: {blocked_iv} 筆")
    if spike_entries: print(f"  IV 噴發進場: {spike_entries} 筆")
