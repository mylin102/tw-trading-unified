...
CSV = Path(__file__).parent.parent.parent / "logs" / "market_data" / "TMF_20260402_PAPER_indicators.csv"
...
def main():
    ...
    actual_csv = Path(__file__).parent.parent.parent / "exports" / "trades" / "TMF_20260402_trades.csv"
