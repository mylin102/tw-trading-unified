...
def main():
    ...
    if args.json:
        ...
        print(f"Overall Rating:              {_fmt(summary.ratings.overall_rating)}")
        print(f"Capture Status:              {_fmt(summary.ratings.capture_status)}")
        print(f"Execution Gate Blocked:      {summary.ratings.execution_gate_blocked}")
        print("---------------------------------------------------------")
        print("Subsystem Ratings:")
        print(f"  - Monotonicity:            {_fmt(summary.ratings.subsystem_ratings.ordering_rating)}")
        print(f"  - Duplicates:              {_fmt(summary.ratings.subsystem_ratings.integrity_rating)}")
        print(f"  - Freshness:               {_fmt(summary.ratings.subsystem_ratings.freshness_rating)}")
        print(f"  - Boundary Contamination:  {_fmt(summary.ratings.subsystem_ratings.generation_rating)}")
        print("---------------------------------------------------------")
